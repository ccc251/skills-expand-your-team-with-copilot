...
def get_activities(
    ...
    - difficulty_level: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for activities with no difficulty specified)
    """
    ...
    if difficulty_level:
        if difficulty_level == "All":
            # "All" means activities with NO difficulty_level specified
            query["difficulty_level"] = {"$exists": False}
        else:
            # Filter for the specific difficulty level
